...
All notable changes to LeForge will be documented in this file.
...
- **UI Rebrand**: Stainless.com-inspired design refresh
  ...
  - Gradient sidebar navigation with updated LeForge logo
...
- Updated `docker-compose.yml` to use unified LeForge app
...
- Initial LeForge platform release
